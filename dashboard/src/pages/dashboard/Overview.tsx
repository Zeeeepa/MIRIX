...
import { ArrowRight, Brain, Users, Coins } from 'lucide-react';

export const Overview: React.FC = () => {
  const { user, refreshUser } = useAuth(); // Client (Admin)
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div
              className={`text-2xl font-bold ${(user?.credits ?? 0) < 1 ? 'text-orange-500' : 'text-emerald-500'}`}
            >
